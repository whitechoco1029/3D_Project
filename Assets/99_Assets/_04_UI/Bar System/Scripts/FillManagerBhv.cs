...
{
    public class FillManagerBhv : UIElementBhv
    {
        // Public properties
        ...
        public void Flash(Color flashColor, int repetitionCount, float lerpFrequency)
        {
            Main.StartFlashing(flashColor, repetitionCount, lerpFrequency);
        }
    }
}